...
from DfpNet import TurbNetG, weights_init, GraphUNet
import dataset
import utils
...
# setup training
epochs = int(iterations/len(trainLoader) + 0.5) + 750
print("expo in channel here:",expo)
netG =  GraphUNet(3,3)
...
print("number of paramteres for this model",sum(p.numel() for p in netG.parameters()))
